...
exports.IdempotencyCleanupJob = void 0;
const common_1 = require("@nestjs/common");
const schedule_1 = require("@nestjs/schedule");
const idempotency_repository_1 = require("./idempotency.repository");
let IdempotencyCleanupJob = class IdempotencyCleanupJob {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
...
exports.IdempotencyCleanupJob = IdempotencyCleanupJob;
__decorate([
    (0, schedule_1.Cron)('0 0 * * *'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], IdempotencyCleanupJob.prototype, "cleanup", null);
exports.IdempotencyCleanupJob = IdempotencyCleanupJob = __decorate([
